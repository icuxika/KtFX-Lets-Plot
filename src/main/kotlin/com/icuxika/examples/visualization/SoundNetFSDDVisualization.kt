...
import com.icuxika.examples.cnn.fsdd.soundBlock
...
private const val MODEL_DIRECTORY = "model/examples/visualization/SoundNetFSDDVisualization"
...
fun exSoundNetFSDDVisualization() {
    example()
}